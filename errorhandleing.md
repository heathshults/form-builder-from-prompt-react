# React Error Boundaries in Next.js Client Components & Next.js Server‑Side Error Handling
  Heath Shults / 4/11/2025 / TechConnect Team
...
### Why Use Error Boundaries in Next.js Client Components?
...
Creating a Client‑Side Error Boundary
...
error.tsx ← global default layout.tsx

### Building error.tsx for Server Components
```tsx
// app/dashboard/error.tsx
"use client"; // required if you want interactivity
...
```
 ...
 ### How Server‑Side Error Boundaries Work
